[![build](https://github.com/opspec-pkgs/git.config.set-option/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.config.set-option/actions/workflows/build.yml)
