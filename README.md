[![Build Status](https://github.com/opspec-pkgs/git.config.set-option/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.config.set-option/actions?query=workflow%3Abuild+branch%3Amain)
